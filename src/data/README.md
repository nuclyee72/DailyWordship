...
| `guesses-2.txt` · `guesses-3.txt` · `guesses-4.txt` | **추측 허용 사전** — 플레이어 입력 단어 검사 | 75,712 · 108,007 · 10,691 |
...
- **추측 허용 사전** = CommonNouns ∪ AllNouns ∪ open-korean-text 일반 명사 ∪ 출제 풀
...
- [han-dle/pd-korean-noun-list-for-wordles](https://github.com/han-dle/pd-korean-noun-list-for-wordles) — **CC0-1.0**
  ...
  - `AllNouns` ← 표준국어대사전 명사
- [open-korean-text](https://github.com/open-korean-text/open-korean-text) `noun/nouns.txt` — **Apache-2.0**
