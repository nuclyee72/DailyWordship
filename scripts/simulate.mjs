 ...
 *
 *   node scripts/simulate.mjs [판 수=200] [시드 접두사=sim] [함대=4,3,3,2]
 *
...
const PREFIX = process.argv[3] || 'sim';
const FLEET_ARG = process.argv[4] ? process.argv[5].split(',').map(Number) : undefined;
const HARD_CAP = 80;
